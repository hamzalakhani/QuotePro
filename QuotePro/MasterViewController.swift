...
// MARK:Properties
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.quoteCell.text = quoteArray[indexPath.row].quoteText
        cell.authorCell.text = quoteArray[indexPath.row].quoteAuthor
        cell.cellImage.image = quoteArray[indexPath.row].randomImage
    ...
    @IBAction func shareButton(_ sender: Any) {
        ...
        let image = table.cellImage.image
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "addSegue" {
            ...
            nextScene?.addItemDelegate = self
        }
    }
